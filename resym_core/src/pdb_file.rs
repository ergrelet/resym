...
pub type SymbolInfoEx = (String, SymbolIndex, SymbolType);
...
fn get_symbol_type(symbol_data: &pdb::SymbolData) -> SymbolType {
    match symbol_data {
        pdb::SymbolData::UserDefinedType(_) => SymbolType::Type,

        // Functions and methods
        pdb::SymbolData::Procedure(_) => SymbolType::Function,

        // Global variables
        pdb::SymbolData::Data(_) => SymbolType::Variable,
